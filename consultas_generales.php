...
<div class="contenedor_imedico">
  <form class="form-consulta" id="frmConsulta" name="formulario" method="POST" onsubmit="return valida();">
...
<div class="detalle">
  ...
  <input type="text" id="inputCostoS" name="costo" value="" onkeypress="return event.charCode >= 46 && event.charCode <= 57">
...
<button class="botonAtrasConsulG" onclick="goBack();"> Atrás </button>
</div>
<script>
  function goBack() {
    window.history.back();
