    ...
    while($fila = mysqli_fetch_assoc($resultado)){
      ...
      <table id="tabla_informe">
       ...
       <tr id="signos">
        ...
        <td id="column_edit">  <a onclick="alert_editarCita(this.href); return false;" class="btnEditar" href="modificar_consulta.php?id=<?php echo base64_encode($codigo)?>&codigo=<?php echo base64_encode($codigoPaciente) ?>&ci=<?php echo base64_encode($codigoInf) ?>"> <img id="pencil" src="assets/img/lapiz.png"> </td>
