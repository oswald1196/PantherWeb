<?php
	...
	$query = "SELECT vchDescripcion, dPrecioCosto, iCodTipoServicio FROM CatServicios WHERE iCodEmpresa = '$cEmpresa' AND iCodServicio = '$servicio' AND iCodEmpresa = '$cEmpresa'";
