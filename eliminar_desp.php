...
<body>
  ...
  <div class="forma_principalD">
    ...
    <div id="contenedorD">
      <button class="botonAddVacunaD"> <a id="enlace_est" href="desparasitacion.php?id=<?php echo base64_encode($codigo)?>&codigo=<?php echo base64_encode($codigoPaciente)?>&cm=<?php echo base64_encode($cMedico)?>"> Agregar <i class="fas fa-plus-square"></i>&nbsp;&nbsp; </a> </button> 
