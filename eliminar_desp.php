        ...
        <table id="carnet_vacunaD">
            <tbody>
                ...
                while($fila = mysqli_fetch_assoc($resultado)){
                    ...
                    ?>
                    <tr>
                        <td class="columna1D" id="fecha"> <?php echo $fila['sFecha'] ?></td>
                        ...
                        <td class="columna8D"> <a onclick=" return alert_fecha();" href="eliminar_desp.php?idD=<?php echo $fila['iCodTranDesparacitacion'] ?>&id=<?php echo base64_encode($codigo)?>&codigo=<?php echo base64_encode($codigoPaciente)?>&cm=<?php echo base64_encode($cMedico)?>" onclick="return alert_eliminarDesp();"> <img src="https://img.icons8.com/ultraviolet/30/000000/delete.png"> </a> </td>
                    </tr>
                    <?php
                }
                ?>
