    ...
    <div id="contenedorD">
      ...
      <table id="carnet_vacunaD">
        <tbody>
          ...
          $query = "SELECT DISTINCT iCodTranDesparacitacion, sProductoAplicado, sNumeroLote, sFecha, sFechaCaducidad, sObservaciones, sFechaProxima, dPeso FROM TranDesparacitacion WHERE iCodPaciente = '$codigoPaciente' ORDER BY iCodDesparacitacion DESC";
